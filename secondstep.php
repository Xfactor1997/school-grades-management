    ...
    <header>
        ...
        <div class="main-content-header">
            ...
            <form method="post" action="thirdstep.php">
                ...
                <td><input type="hidden" name="class" class="class" value="<?php  echo $_POST['class']; ?>" required />
                </td>

                <td><input type="hidden" name="rollno" class="rollno" value="<?php  echo $_POST['rollno']; ?>"
                        required /></td>
