        ...
        <div class="main-content-header">
            <form method='post'>
                <table class="table">
                    ...
                    <tr>
                        <td class='tbldata'><input type='text' class='tbldata' name='email' placeholder='Email Id'
                                Required /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class='tbldata'><input type='text' class='tbldata' name='cont' placeholder='Contact No'
                                Required /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan='2' align='center'><input type="submit" name='submit' value='SEND' class='submit' />
                        </td>
                    </tr>
                </table>
            </form>
